...
IMG_DIR_TRAIN   = '../fiba_basketball4/train'
ANN_FILE_TRAIN  = '../fiba_basketball4/train/annos_train.json'
IMG_DIR_VAL     = '../fiba_basketball4/val'
ANN_FILE_VAL    = '../fiba_basketball4/val/annos_val.json'

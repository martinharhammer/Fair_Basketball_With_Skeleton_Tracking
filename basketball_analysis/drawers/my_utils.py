...
def draw_ball_circle(frame, point, color, radius=6):
    """
    Draw a circle at the ball center point [x, y].

    Args:
        frame (numpy.ndarray): Frame to draw on.
        point (list or tuple): Ball center [x, y].
        color (tuple): Circle color in BGR.
        radius (int): Circle radius in pixels.
        outline_color (tuple): Outline color in BGR.

...
class BallAquisitionDetector:
    ...
    def calculate_ball_containment_ratio(self, player_bbox, ball_point):
        """
        Containment for point-style ball annotations.
        Returns 1.0 if the ball point lies inside the player bbox, else 0.0.
        """

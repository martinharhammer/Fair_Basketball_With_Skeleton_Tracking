...
IMG_DIR_TRAIN   = '../fiba_basketball6/train'
ANN_FILE_TRAIN  = '../fiba_basketball6/train/annos_train.json'
IMG_DIR_VAL     = '../fiba_basketball6/val'
ANN_FILE_VAL    = '../fiba_basketball6/val/annos_val.json'
